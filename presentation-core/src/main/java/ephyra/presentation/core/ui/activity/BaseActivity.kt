...
open class BaseActivity :
    AppCompatActivity(),
    SecureActivityDelegate by CoreContainer.get(SecureActivityDelegate::class.java),
    ThemingDelegate by CoreContainer.get(ThemingDelegate::class.java) {

    private val uiPreferences: UiPreferences = CoreContainer.get()
