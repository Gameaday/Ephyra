...
object MangaMapper {
    ...
    fun mapToEntity(manga: Manga): MangaEntity = MangaEntity(
        id = manga.id,
        source = manga.source,
        url = manga.url,
        artist = manga.artist,
        ...
        updateStrategy = manga.updateStrategy.ordinal,
        ...
        sourceStatus = manga.sourceStatus,
        alternativeTitles = serializeAlternativeTitles(manga.alternativeTitles),
        deadSince = manga.deadSince,
        contentType = manga.contentType.value,
