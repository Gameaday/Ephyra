...
/**
 * Configuration options for a restore operation.
 *
 * Lives in `domain` so that feature modules (e.g. `feature/settings`) can
 * reference this type without importing the `data` layer.
 */
