...
enum class ReaderOrientation(
    ...
    FREE(
        flag = -1, // ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED
        ephyra.app.core.common.R.string.rotation_free,
        0x00000008,
    ),
    PORTRAIT(
        flag = 7, // ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT
        ephyra.app.core.common.R.string.rotation_portrait,
        0x00000010,
    ),
    LANDSCAPE(
        flag = 6, // ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE
        ephyra.app.core.common.R.string.rotation_landscape,
        0x00000018,
    ),
    LOCKED_PORTRAIT(
        flag = 1, // ActivityInfo.SCREEN_ORIENTATION_PORTRAIT
        ephyra.app.core.common.R.string.rotation_force_portrait,
        0x00000020,
    ),
    LOCKED_LANDSCAPE(
        flag = 0, // ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE
        ephyra.app.core.common.R.string.rotation_force_landscape,
        0x00000028,
    ),
    REVERSE_PORTRAIT(
        flag = 9, // ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT
        ephyra.app.core.common.R.string.rotation_reverse_portrait,
        0x00000030,
    ),
    ;
