...
data class LibraryItem(
    ...
    val title: String = libraryManga.manga.title
    val subtitle: String? = libraryManga.manga.author
    val coverUrl: String? = libraryManga.manga.thumbnailUrl
    val isFavorite: Boolean = libraryManga.manga.favorite
    val genres: List<String>? = libraryManga.manga.genre
    val canonicalId: String? = libraryManga.manga.canonicalId
    val coverLastModified: Long = libraryManga.manga.coverLastModified
    val sourceStatus: Int = libraryManga.manga.sourceStatus
