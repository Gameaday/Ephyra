...
fun ChapterSettingsDialog(
    ...
    TabbedDialog(
        ...
        tabOverflowMenuContent = { closeMenu ->
            DropdownMenuItem(
                text = { Text(stringResource(ephyra.app.core.common.R.string.set_chapter_settings_as_default)) },
                onClick = {
...
fun ScanlatorFilterItem(
    ...
    Row(
        ...
        Text(
            text = stringResource(ephyra.app.core.common.R.string.scanlator),
...
private fun ColumnScope.SortPage(
    ...
    listOf(
        ephyra.app.core.common.R.string.sort_by_source to Manga.CHAPTER_SORTING_SOURCE,
        ephyra.app.core.common.R.string.sort_by_number to Manga.CHAPTER_SORTING_NUMBER,
        ephyra.app.core.common.R.string.sort_by_upload_date to Manga.CHAPTER_SORTING_UPLOAD_DATE,
        ephyra.app.core.common.R.string.action_sort_alpha to Manga.CHAPTER_SORTING_ALPHABET,
    ).map { (titleRes, mode) ->
        SortItem(
...
private fun ColumnScope.DisplayPage(
    ...
    listOf(
        ephyra.app.core.common.R.string.show_title to Manga.CHAPTER_DISPLAY_NAME,
        ephyra.app.core.common.R.string.show_chapter_number to Manga.CHAPTER_DISPLAY_NUMBER,
    ).map { (titleRes, mode) ->
        RadioItem(
            label = stringResource(titleRes),
...
private fun SetAsDefaultDialog(
    ...
    AlertDialog(
        onDismissRequest = onDismissRequest,
        title = { Text(text = stringResource(ephyra.app.core.common.R.string.chapter_settings)) },
        text = {
            Column(
                verticalArrangement = Arrangement.spacedBy(12.dp),
            ) {
                Text(text = stringResource(ephyra.app.core.common.R.string.confirm_set_chapter_settings))

                LabeledCheckbox(
                    label = stringResource(ephyra.app.core.common.R.string.also_set_chapter_settings_for_library),
