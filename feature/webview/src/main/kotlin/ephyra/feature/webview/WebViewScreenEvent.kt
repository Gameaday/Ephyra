 ...
 * For side-effects that require Activity context, [WebViewViewModel] emits a [WebViewEffect].
 */
...
/**
 * One-shot UI side-effects emitted by [WebViewViewModel].
 * The composable collects these via [WebViewViewModel.effectFlow] and calls
