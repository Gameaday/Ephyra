...
| DATA-001I | Production parity matrix and migration rehearsal fixture. | Agent | [Target data parity matrix](TARGET_DATA_PARITY.md) + `TargetMigrationRehearsalTest`; category, tracking, and target backup coverage added; downloads, source lifecycle, multi-source aggregation, production tracker cutover, and production cutover remain open | IN_PROGRESS |
