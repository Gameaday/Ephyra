...
| DATA-001I | Production parity matrix and migration rehearsal fixture. | Agent | [Target data parity matrix](TARGET_DATA_PARITY.md) + `TargetMigrationRehearsalTest`; category, tracking, target backup, and [download artifact contract](DOWNLOAD_ARTIFACT_CONTRACT.md) covered; source lifecycle, multi-source aggregation, production tracker cutover, download index/filesystem reconciliation, and production cutover remain open | IN_PROGRESS |
