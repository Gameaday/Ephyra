...
19. `DATA-001I`: production parity matrix and migration rehearsal fixture. **In progress**; the capability matrix is complete, while the multi-source fixture and production-like rehearsal remain open. See `doc/TARGET_DATA_PARITY.md`.
